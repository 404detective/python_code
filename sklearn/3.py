...
if __name__ == '__main__':
    ''' 数据路径 '''
    path='E:\Desktop\python_code\sklearn\课程数据\分类\\'
    featurePaths = [path+'A.feature',path+'B.feature',path+'C.feature',path+'D.feature',path+'E.feature']
    labelPaths = [path+'A.label',path+'B.label',path+'C.label',path+'D.label',path+'E.label']

...
catch_data_pingpang2={
    'qz':'0',
    'jxb_ids':'',
    'kch_id':'XT108005',
    'gnmkdm':'N253512',
    'su':'2019211551',
    'rlkz':'0',
    ...
    'kcmc':'(XT108005)乒乓球 - 1 学分',
    
    'xkkz_id':'B93918496D0B7A10E0536685C2CA0AEE',
...
# 
catch_data_xiandai={
    'qz':'0',
...
response = session.post(catch_url,headers=headers,data=catch_data_pingpang2)

print('乒乓球',response.text)

# response = session.post(catch_url,headers=headers,data=catch_data_xiandai)

# print('线性代数',response.text)

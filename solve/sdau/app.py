...
if __name__ == "__main__":
	# 登录主页url
    login_url = "http://xjw.sdau.edu.cn//jwglxt/xtgl/login_slogin.html?language=zh_CN&_t="
    # 请求PublicKey的URL
    login_KeyUrl = "http://xjw.sdau.edu.cn//jwglxt/xtgl/login_getPublicKey.html?time="
	# 登录后的课表URL
    table_url = "http://xjw.sdau.edu.cn//jwglxt/kbcx/xskbcx_cxXsKb.html?gnmkdm=N2151"
